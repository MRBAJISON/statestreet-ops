...
export const performanceTargets = pgTable(
  ...
  (t) => [
    ...
    check('targets_period_type_check', sql`${t.periodType} in ('day', 'week', 'month', 'quarter', 'year')`),
    check('targets_recurring_period_check', sql`${t.recurring} = false or ${t.periodType} in ('day', 'week', 'month')`),
